...
transport.sendMail({
    ...
    html: ` <table role="presentation" style={{ width: '100%', borderCollapse: 'collapse', border: '0', borderSpacing: '0', background: '#131313' }}>
    <tr>
        <td align="center" style={{ padding: '0' }}>
            <table role="presentation" style={{ width: '100%', maxWidth: '600px', borderCollapse: 'collapse', borderSpacing: '0', textAlign: 'left' }}>
                <tr>
                ...
                <tr>
                    <td style={{ padding: '36px 30px 42px 30px', background: '#fff', borderRadius: '10px' }}>
                        <table role="presentation" style={{ width: '100%', borderCollapse: 'collapse', border: '0', borderSpacing: '0' }}>
                            <tr>
                                <td style={{ padding: '0 0 20px 0', color: '#153643', textAlign: 'center' }}>
                                    <p style={{ margin: '0 0 12px 0', fontSize: '16px', lineHeight: '24px', fontFamily: 'Arial,sans-serif' }}>
                                        Hi there ${name},
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td style={{ padding: '0' }}>
                                    <table role="presentation" style={{ width: '100%', borderCollapse: 'collapse', border:'0', borderSpacing: '0' }}>
                                        <tr>
                                            <td style={{ width: '260px', padding: '0', verticalAlign: 'top', color: '#153643' }}>
                                                <p style={{ margin: '0 0 25px 0', fontSize: '16px', lineHeight: '24px', fontFamily: 'Arial,sans-serif' }}>
                                                    <div style={{ height: 'auto', display: 'block', margin: 'auto', background: '#131313', width: '200px', padding: '20px', fontSize: '40px', color: '#fff', textAlign: 'center', borderRadius: '5px' }}>
                                                        ${text}
                                                    </div>
                                                </p>
                                                <p style={{ margin: '0 0 25px 0', fontSize: '16px', lineHeight: '24px', fontFamily: 'Arial,sans-serif', textAlign: 'center' }}>Enter it on the Lumos Exchange to confirm your email for 2FA. This code will expire in 60 minutes.</p>
                                                <p style={{ margin: '0', fontSize: '16px', lineHeight: '24px', fontFamily: 'Arial,sans-serif', textAlign: 'center' }}>Thanks, The Lumos Team.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
