    ...
    return (
      <div className="position-relative">
        ...
        {filteredUserPayments.map((data, index) => (
          <PaymentMethodCard
            className="p-4 mb-3 d-flex align-items-center row position-relative"
            key={index}
          >
            ...
            {modalMode === "initial" && (
              <ModalBody className="row">
                <AddBankButton
                  ...
                  className="mb-2"
                  disabled={test.includes("UK Bank Account")}
                >
                ...
                <AddBankButton
                  ...
                  className="mb-2"
                  disabled={test.includes("EU Bank Account")}
                >
                  <div className="col-12 p-4 rounded d-flex justify-content-between align-items-center inner">
                    <div className="d-flex">
                      <i className="material-icons me-2 d-flex align-items-center">
                ...
                <AddBankButton
                  ...
                  className="mb-2"
                  disabled={test.includes("International Bank")}
                >
                  <div className="col-12 p-4 rounded d-flex justify-content-between align-items-center inner">
                    <div className="d-flex">
                      <i className="material-icons me-2 d-flex align-items-center">
                    ...
                    <i className="material-icons arrow">
                      {test.includes("International Bank")
                        ? "check_circle"
                        : "arrow_forward"}
                    </i>
                  </div>
              ...
              <ModalBody className="p-4">
                ...
                <div className="col-12 mb-3">
                  <StyledLabel padding="0 0 10px 0" bold htmlFor="IBAN">
                    IBAN{" "}
                    {IBAN.length > 0 && (
                      <span className={IBAN.length > 40 && "showError"}>
                        {" "}
                        - {IBAN.length}/40
                      </span>
                    )}
                ...
                <div className="col-12 mb-3">
                  ...
                  <FormInput
                    ...
                    className={`
								mb-3 w-100
								${
                  ((bankCountry.length > 0 && bankCountry.length < 4) ||
                    bankCountry.match(/[^A-Za-z]/g)) &&
                  "invalid"
                }
							`}
                    onChange={(e) => {
                ...
                <div className="col-12">
                  <PrimaryButton
                    ...
                    disabled={
                      bankName.length === 0 ||
                      bankCity.length === 0 ||
                      bankCountry.length < 4 ||
                      (bankCountry.length > 0 && bankCountry.length < 4) ||
                      bankCountry.includes(" ") ||
                      bankCountry.match(/[^A-Za-z]/g) ||
                      BIC.length < 8 ||
                      payeeName.length === 0
                    }
