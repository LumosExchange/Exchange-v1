	...
	const ShowAddedPaymentMethods = () => {
		...
		const deletePayment = () => {
			...
			if (deleteModalData.type === "paypal") {
				Axios.post(`${AppUrl}/deletePaypalBank`).then((response) => {
					if (response.status === 200) {
						setDeleteConfirmationMessage(response.data.message);
						setDeleteModalMode("confirmation");
					}
			...
			if (deleteModalData.type === "skrill") {
				Axios.post(`${AppUrl}/deleteSkrillBank`).then((response) => {
					if (response.status === 200) {
						setDeleteConfirmationMessage(response.data.message);
						setDeleteModalMode("confirmation");
					}
			...
			<div className="position-relative">
				...
				{filteredUserPayments.map((data, index) => (
					<PaymentMethodCard className="p-4 mb-3 d-flex align-items-center row position-relative" key={index}>
						...
						<div className="col-12 col-lg-2 d-none d-lg-flex justify-content-end">
							<InvisibleButton className="me-2" title="Edit" onClick={() => openEditModal(data.data)}>
				...
				<StyledModal centered isOpen={deleteModal} toggle={toggleDelete}>
					...
					{deleteModalMode === "initial" && (
						<ModalBody>
							<Paragraph size="18px">
								Are you sure you want to remove {deleteModalData.name} as a payment method?
							</Paragraph>
							<div className="row">
					...
					{deleteModalMode === "confirmation" && (
						<ModalBody className="p-4">
							...
							<PrimaryButton text="OK" className="w-100" onClick={reloadPayments} />
						</ModalBody>
					)}
				</StyledModal>
			</div>
				...
				<ContentTab className="text-white">
					...
					<StyledModal centered isOpen={modal} toggle={toggle}>
						{modalMode !== "confirmation" && (
							<ModalHeader className="d-flex align-items-center">
								{modalMode !== "initial" && !isEditing && (
									<InvisibleButton onClick={() => goBack()} className="d-flex align-items-center">
								...
								<div>
									{(modalMode === "initial" && "Add a Payment Method") ||
										(modalMode === "ukbank" &&
											(isEditing ? "Edit UK Bank Account" : "Add UK Bank Account")) ||
										(modalMode === "eubank" &&
											(isEditing ? "Edit EU Bank Account" : "Add EU Bank Account")) ||
										(modalMode === "intbank" &&
											(isEditing
										...
										(modalMode === "card" &&
											(isEditing ? "Edit Credit/Debit Card" : "Add Credit/Debit Card")) ||
										(modalMode === "paypal" &&
											(isEditing ? "Edit PayPal Account" : "Add PayPal Account")) ||
										(modalMode === "skrill" &&
											(isEditing ? "Edit Skrill Account" : "Add Skrill Account"))}
								</div>
							</ModalHeader>
						)}
						{modalMode === "initial" && (
							...
							<ModalBody className="p-4">
								<form>
									...
									<div className="col-12 mb-4 row">
										<div className="col-4">
											<StyledLabel padding="0 0 10px 0" bold htmlFor="expiration">
												Expiration
											</StyledLabel>
											<FormInput
												type="text"
							...
							<ModalBody className="p-4">
								<form>
									<div className="col-12 mb-3 row">
										<div className="col-12">
											<StyledLabel padding="0 0 10px 0" bold htmlFor="sort-part-1">
												Sort Code
											</StyledLabel>
										</div>
										<div className="col-3">
									...
									<div className="col-12 mb-4">
										<StyledLabel padding="0 0 10px 0" bold htmlFor="accountNumber">
											Account Number
										</StyledLabel>
										<FormInput
											type="text"
									...
									<div className="col-12">
										<PrimaryButton
											...
											className="w-100"
											disabled={
												sortCode.length > 6 || sortCode.length < 6 || accountNumber.length < 8
											}
											onClick={(event) => {
							...
							<ModalBody className="p-4">
								...
								<div className="col-12 mb-3">
									<StyledLabel padding="0 0 10px 0" bold htmlFor="IBAN">
										IBAN{" "}
										{IBAN.length > 0 && (
											<span className={IBAN.length > 32 && "showError"}> - {IBAN.length}/32</span>
										)}
									</StyledLabel>
									<FormInput
										type="text"
						...
						{modalMode === "intbankPage2" && (
							<ModalBody className="p-4">
								<div className="col-12 mb-4">
									<StyledLabel padding="0 0 10px 0" bold htmlFor="intermediateBankName">
								...
								<div className="col-12 mb-4">
									<StyledLabel padding="0 0 10px 0" bold htmlFor="intermediateBankCity">
								...
								<div className="col-12 mb-4">
									<StyledLabel padding="0 0 10px 0" bold htmlFor="intermediateBankCountry">
								...
								<div className="col-12 mb-4">
									<StyledLabel padding="0 0 10px 0" bold htmlFor="intermediateBankAccountNumber">
								...
								<div className="col-12 mb-4">
									<StyledLabel padding="0 0 10px 0" bold htmlFor="intermediateBankRoutingNumber">
