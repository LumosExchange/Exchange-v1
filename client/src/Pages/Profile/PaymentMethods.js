	...
	const ShowAddedPaymentMethods = () => {
		...
		const deletePayment = () => {
			if (deleteModalData.type === "ukbank"){
				Axios.post(`http://localhost:3001/deleteUKBank`)
				.then((response) => {
			...
			if (deleteModalData.type === "eubank"){
				Axios.post(`http://localhost:3001/deleteEUBank`)
				.then((response) => {
					if (response.status === 200){
						setDeleteConfirmationMessage(response.data.message);
						setDeleteModalMode('confirmation');
			...
			if (deleteModalData.type === "internationalBank"){
				Axios.post(`http://localhost:3001/deleteInterBank`)
				.then((response) => {
					if (response.status === 200){
						setDeleteConfirmationMessage(response.data.message);
						setDeleteModalMode('confirmation');
			...
			if (deleteModalData.type === "paypal"){
				Axios.post(`http://localhost:3001/deletePaypalBank`)
				.then((response) => {
					if (response.status === 200){
						setDeleteConfirmationMessage(response.data.message);
						setDeleteModalMode('confirmation');
			...
			if (deleteModalData.type === "skrill"){
				Axios.post(`http://localhost:3001/deleteSkrillBank`)
				.then((response) => {
					if (response.status === 200){
						setDeleteConfirmationMessage(response.data.message);
						setDeleteModalMode('confirmation');
