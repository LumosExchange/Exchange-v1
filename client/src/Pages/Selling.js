...
const Selling = ({ userName }) => {
  ...
  const getTradeDetails = () => {
    axios
      ...
      .then((response) => {
        ...
        setSellerAddress(response.data[0].sellerAddress);
        setStakeId(response.data[0].stakeId);
        //Get buyer username
  ...
  const sentSolMsg = () => {
    const messageData = {
      ...
      author: "Lumos Exchange",
      message:
        "Please note " + userName + " has confirmed they have sent the solana",
      time:
        new Date(Date.now()).getHours() +
        ":" +
        new Date(Date.now()).getMinutes(),
          ...
          {currentStep === "transfer" && (
            <div className="col-12 col-md-5 mt-4">
              ...
              <div className="col-12 text-center">
                ...
                <Paragraph size="18px">
                  Needs to be sent to the wallet addresss:
                </Paragraph>
