...
const ClearFilterButton = styled(InvisibleButton)(
  ({ theme }) => css`
...
const Buy = ({ solGbp, solUsd, currency, userName }) => {
  ...
  const [searchCriteriaPayment, setSearchCriteriaPayment] =
    useState("Please Select");
  const [searchCriteriaLocation, setSearchCriteriaLocation] =
    useState("Please Select");
  const [searchCriteriaFeedback, setSearchCriteriaFeedback] =
    useState("Please Select");
  const [searchCriteriaPrice, setSearchCriteriaPrice] =
    useState("Please select");
      ...
      <div className="container">
        <div className="row pt-5">
          <div className="col-12 col-md-5 col-xl-4">
            <Card radius="10px" className="p-4">
              <div className="d-flex">
                <div className="col-6">
                  <ToggleButton className="left w-100 selected">
                    Buy
                  </ToggleButton>
                </div>
                <div className="col-6">
          ...
          <div className="col-12 col-md-7 col-xl-8 mt-4 mt-md-0 position-relative">
            {allListings.length === 0 && <LoadingState />}
            <div className="d-flex justify-content-between flex-row pb-2">
              <Heading size="24px">
                Buy {selectedCrypto} from these Sellers
              </Heading>
              {/*
              ...
              <ListingArea>
                {isFiltering && (
                  <div className="d-flex mb-3 align-items-baseline">
                    <Paragraph size="20px" bold className="mb-0 me-1">
                ...
                {isFiltering
                  ...
                  : allListings
                      .filter((al) => al.userName !== userName)
                      .map((val, index) => (
                        <TradeCard
                          val={val}
                          solGbp={solGbp}
            ...
            {(selectedCrypto === "KIN" ||
              selectedCrypto === "COPE" ||
              selectedCrypto === "LRA") && (
              <Paragraph size="20px" bold className="pt-2">
                Coming Soon
              </Paragraph>
            )}
          </div>
