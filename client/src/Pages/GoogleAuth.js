...
function GoogleAuth() {
    ...
    return (
        ...
        <div className="container col-12 col-md-8 col-xl-5 col-xxl-4">
          ...
          >
            <Heading className="pb-4 text-center" bold>Add Google Auth</Heading>
            <StyledLabel
            ...
            >
              ...
              know your current password before you will be allowed to add google auth to your account.
            </StyledLabel>
            {!isCodeSent ? (
              <PrimaryButton
                  text="Get Code"
