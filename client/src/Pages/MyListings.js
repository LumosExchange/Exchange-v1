  ...
  return (
    <PageBody
      className={`d-flex position-relative ${
        userListings.length === 0 ? "align-items-center" : "align-items-start"
      }`}
    >
      <div className="container d-flex justify-content-center py-5 flex-column">
        ...
        {userListings.length === 0 && (
          <div className="d-flex align-items-center justify-content-center flex-column">
            <MissingIcon className="material-icons mb-3">
              manage_search
            </MissingIcon>
        ...
        <StyledModal centered isOpen={modal} toggle={openEditModal}>
          <ModalHeader>Edit Listing</ModalHeader>
          {modalMode === "initial" && (
            <ModalBody>
              <div className="col-12 mb-4">
                <StyledLabel padding="0 0 10px 0" bold htmlFor="primaryPayment">
              ...
              <div className="col-12 mb-4 d-flex">
                ...
                <div className="col-1 d-flex align-items-center justify-content-center">
                  <Paragraph bold className="mb-0" size="24px">
                    %
                  </Paragraph>
                </div>
                <div className="col-9">
              ...
              <div className="col-12 mb-4">
                <StyledLabel padding="0 0 10px 0" htmlFor="volumeForSale" bold>
                  Amount for Sale
                </StyledLabel>
                <FormInput
                  type="number"
          ...
          {modalMode === "error" && (
            <ModalBody className="p-4">
              ...
              <PrimaryButton text="OK" className="w-100" onClick={null} />
            </ModalBody>
          )}
        </StyledModal>
        <StyledModal centered isOpen={deleteModal} toggle={openDeleteModal}>
