...
const ProfileLink = styled(InvisibleButton)(
  ({ theme }) => css`
...
const TradeCard = ({
  ...
  const priceAbove =
    val.aboveOrBelow === "above" &&
    ((solGbp / 100) * (100 + val.percentChange)).toFixed(2);
  const priceBelow =
    val.aboveOrBelow === "below" &&
    ((solGbp / 100) * (100 - val.percentChange)).toFixed(2);
    ...
    <Card className="p-3 mb-3" color="grey">
      <div className="row">
        ...
        <div className="col-12 col-xl-6 d-flex align-items-center mb-0">
          ...
          <Paragraph size="18px" className="mb-0 text-truncate overflow-hidden">
        ...
        <div className="col-12 col-xl-3 d-flex flex-column align-items-xl-end mb-3 mb-xl-0">
          ...
          <Paragraph size="16px" className="mb-0">
            {val.percentChange}% {val.aboveOrBelow} market
          </Paragraph>
          <Paragraph size="16px" className="mb-0">
        ...
        <div className="col-12 col-xl-6 d-flex mb-3 mb-xl-0">
          <Paragraph size="18px" className="mb-0 overflow-hidden text-truncate">
            {val.paymentMethod1 || val.paymentMethods[0]},{" "}
            {val.paymentMethod2 || val.paymentMethods[1]}
          </Paragraph>
        </div>
        {!withoutButton && (
...
export const ActiveTradeCard = ({
  ...
  const formattedCurrencySymbol = convertCurrencyToSymbol(
    tradeInfo.paymentCurrency
  );
          ...
          <div className="d-flex flex-column">
            ...
            {!noMessage && tradeInfo.Message && (
              <div className="d-flex">
                ...
                <Paragraph
                  size="18px"
                  className="mb-0 overflow-hidden text-truncate"
                >
                  {tradeInfo.Message}
                </Paragraph>
              </div>
