...
const PositiveFeedbackButton = styled.button(
  ({ theme }) => css`
    ...
    &.active {
      ...
      i {
        animation: ${PulseIcon} 0.3s linear 1;
      }
    }
  `
);

const NeutralFeedbackButton = styled.button(
  ({ theme }) => css`
...
const NegativeFeedbackButton = styled.button(
  ({ theme }) => css`
...
export const GiveFeedback = () => {
  ...
  return (
    <React.Fragment>
      <div className="d-flex justify-content-center">
        <div>
          <PositiveFeedbackButton
            className={`d-flex align-items-center justify-content-center ps-3 pe-2 py-2 ${
        ...
        <div>
          <NegativeFeedbackButton
            className={`d-flex align-items-center justify-content-center ps-2 pe-3 py-2 ${
      ...
      {feedBack && (
        <Paragraph className="mt-2">Giving {feedBack} feedback.</Paragraph>
      )}
    </React.Fragment>
  );
};

const LumosIconBase = styled.svg(
  ({ theme }) => css`
    #lumos-logo-outlines {
...
export const IconPrimaryCta = styled.i(
  ({ theme }) => css`
    color: ${theme.colors.primary_cta};
  `
);
...
export const TradeHistoryTab = styled.div(
  ({ theme }) => css`
    cursor: pointer;
...
export const TradeHistoryTabs = ({ selected }) => {
  ...
  return (
    <Tabs className="d-flex align-items-end">
      <TradeHistoryTab
        onClick={() => navigate("/TradeHistory/Buy")}
        className={selected === "Buy" && "selected"}
      >
        Buy
      </TradeHistoryTab>
      <TradeHistoryTab
        onClick={() => navigate("/TradeHistory/Sell")}
        className={selected === "Sell" && "selected"}
      >
        Sell
      </TradeHistoryTab>
      <TradeHistoryTab
        onClick={() => navigate("/TradeHistory/Completed")}
