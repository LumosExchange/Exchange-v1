...
const LumosLogo = ({ width, height }) => (
    <svg width={width} height={height} viewBox="0 0 117 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="logo">
        <title>lumos-logo</title>
        <g id="lumos-logo" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            ...
            <text id="LUMOS" fillRule="nonzero" fontFamily="MontserratRoman-Bold, Montserrat" fontSize="21" fontWeight="bold" letterSpacing="-0.5">
