...
const LumosLogo = ({ width, height }) => (
    <svg width={width} height={height} viewBox="0 0 117 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" class="logo">
        <title>lumos-logo</title>
        <g id="lumos-logo" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <text id="LUMOS" fill-rule="nonzero" font-family="MontserratRoman-Bold, Montserrat" font-size="21" font-weight="bold" letter-spacing="-0.5">
                <tspan x="36" y="22">LUMOS</tspan>
            </text>
        </g>
    </svg>
);
